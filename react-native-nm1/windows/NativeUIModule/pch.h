...
#define NATIVE_UI_MODULE // undef if NATIVE_MODULE
#undef NATIVE_MODULE // undef if NATIVE_UI_MODULE
...
#define NAMESPACE NativeUIModule // Don't forget to update the .XAML and .IDL files for this namespace
